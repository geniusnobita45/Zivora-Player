...
-- BEGIN schema/001_auth_catalog_media.sql
...
-- END schema/001_auth_catalog_media.sql

-- BEGIN indexes/001_auth_catalog_media.sql
...
create index subtitle_tracks_forced_idx
  ...
  where is_forced;
-- END indexes/001_auth_catalog_media.sql

-- BEGIN policies/001_auth_catalog_media.sql
...
-- END policies/001_auth_catalog_media.sql

-- BEGIN functions/001_auth_catalog_media.sql
...
-- END functions/001_auth_catalog_media.sql
